...
public class PublisherCredentials {
    ...
    public static String DEFAULT_PUBLISHER_DISPATCH_EXCHANGE = "cyclops.usage.generator.dispatch";
    public static String DEFAULT_PUBLISHER_BROADCAST_EXCHANGE = "cyclops.usage.generator.broadcast";
