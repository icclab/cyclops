...
public class Service {
    ...
    public Restlet createInboundRoot() throws Exception {
        ...
        logger.trace("Initialising OpenStack Usage Generator microservice and creating routes");

        router = attachRoutes();

        logger.trace("Routes for OpenStack Usage Generato microservice successfully created");
