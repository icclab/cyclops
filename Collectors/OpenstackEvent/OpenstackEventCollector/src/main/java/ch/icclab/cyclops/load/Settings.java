...
public class Settings {
    ...
    private OpenstackCredentials loadOpenstackCredentials() {
        ...
        openstackCredentials.setOpenstackEndpoint(properties.getProperty("OpenstackEndpoint"));
        openstackCredentials.setOpenstackUsername(properties.getProperty("OpenstackUsername"));
        openstackCredentials.setOpenstackPassword(properties.getProperty("OpenstackPassword"));
        openstackCredentials.setOpenstackTenant(properties.getProperty("OpenstackTenant"));
    ...
    private OpenstackSettings loadOpenstackSettings() {
        ...
        openstackSettings.setDefaultVolumeAttachment(Integer.parseInt(properties.getProperty("DefaultVolumeAttachment")));
        openstackSettings.setOpenstackDefaultRegion(properties.getProperty("OpenstackDefaultRegion"));
        openstackSettings.setEstablishBindings(Boolean.valueOf(properties.getProperty("EstablishBindings")));
    ...
    private ConsumerCredentials loadConsumerCredentials() {
        ...
        consumerCredentials.setConsumerNovaRoutingKey(properties.getProperty("ConsumerNovaRoutingKey"));
        consumerCredentials.setConsumerExchangeToBindNova(properties.getProperty("ConsumerExchangeToBindNova"));
        consumerCredentials.setConsumerCinderQueue(properties.getProperty("ConsumerCinderQueue"));
        consumerCredentials.setConsumerCinderRoutingKey(properties.getProperty("ConsumerCinderRoutingKey"));
        consumerCredentials.setConsumerExchangeToBindCinder(properties.getProperty("ConsumerExchangeToBindCinder"));
        consumerCredentials.setConsumerNeutronQueue(properties.getProperty("ConsumerNeutronQueue"));
        consumerCredentials.setConsumerNeutronRoutingKey(properties.getProperty("ConsumerNeutronRoutingKey"));
        consumerCredentials.setConsumerExchangeToBindNeutron(properties.getProperty("ConsumerExchangeToBindNeutron"));
