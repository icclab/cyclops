        ...
        public class Args {
            ...
            public class ObjInst {
                ...
                public class Nova_objectData{
                    ...
                    public String getVm_state(){ return vm_state; }
                    ...
                    public System_Metadata getSystem_metadata(){return system_metadata;}

                    public class System_Metadata {
                        String instance_type_name;

                        public String getInstance_type_name() { return instance_type_name;}
                    }

                    public class Flavor{
                        @SerializedName("nova_object.data")
                        private NovaObjectData nova_objectData;

                        public NovaObjectData getNova_objectData() {
                            return nova_objectData;
                        }
                        public class NovaObjectData{
                            String name;
