...
public class PublisherCredentials {
    ...
    public static String DEFAULT_PUBLISHER_DISPATCH_EXCHANGE = "cyclops.billing.dispatch";
    public static String DEFAULT_PUBLISHER_BROADCAST_EXCHANGE = "cyclops.billing.broadcast";
