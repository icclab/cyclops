...
public class Service {
    ...
    private void initialiseApplication() {
        logger.trace("Initialising Billing microservice");
    ...
    public Restlet createInboundRoot() throws Exception {
        ...
        logger.trace("Creating routes for Billing microservice");
        ...
        logger.trace("Routes for Billing microservice successfully created");
