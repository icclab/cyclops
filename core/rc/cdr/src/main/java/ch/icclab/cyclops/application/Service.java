...
public class Service {
    ...
    private void initialiseApplication() {
        logger.trace("Initialising CDR microservice");
    ...
    public Restlet createInboundRoot() throws Exception {
        ...
        logger.trace("Creating routes for CDR microservice");
        ...
        logger.trace("Routes for CDR microservice successfully created");
