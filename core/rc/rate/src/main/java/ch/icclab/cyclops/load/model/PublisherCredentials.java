...
public class PublisherCredentials {
    ...
    public static String DEFAULT_PUBLISHER_DISPATCH_EXCHANGE = "cyclops.rate.dispatch";
    public static String DEFAULT_PUBLISHER_BROADCAST_EXCHANGE = "cyclops.rate.broadcast";
    public static String DEFAULT_ROUTING_KEY_IF_MISSING = "default_key";
    ...
    private Boolean publisherByDefaultDispatchInsteadOfBroadcast;
    private String publisherDefaultRoutingKeyIfMissing;
    ...
    public Boolean dispatchInsteadOfBroadcast() {
        return publisherByDefaultDispatchInsteadOfBroadcast;
    }
    public void setPublisherByDefaultDispatchInsteadOfBroadcast(Boolean publisherByDefaultDispatchInsteadOfBroadcast) {
        this.publisherByDefaultDispatchInsteadOfBroadcast = publisherByDefaultDispatchInsteadOfBroadcast;
    }

    public String getPublisherDefaultRoutingKeyIfMissing() {
        return publisherDefaultRoutingKeyIfMissing;
    }
    public void setPublisherDefaultRoutingKeyIfMissing(String publisherDefaultRoutingKeyIfMissing) {
        this.publisherDefaultRoutingKeyIfMissing = publisherDefaultRoutingKeyIfMissing;
    }
}
