...
import ch.icclab.cyclops.consume.data.UsageConsumer;
...
public class ConsumeManager {
    ...
    public static boolean startDataAndCommandProcessing() {
        ...
        if (listener != null) {
            ...
            boolean data = listener.addConsumer(consumerCredentials.getConsumerDataQueue(), new UsageConsumer(), threads);
