# -*- coding: utf-8 -*-
#
# Cyclops documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Cyclops.tex', u'Cyclops Documentation',
     u'CAB Team@SPLab/ICCLab - ZHAW', 'manual'),
]
