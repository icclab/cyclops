...
public class PublisherCredentials {
    ...
    public static String DEFAULT_PUBLISHER_DISPATCH_EXCHANGE = "cyclops.box.dispatch";
    public static String DEFAULT_PUBLISHER_BROADCAST_EXCHANGE = "cyclops.box.broadcast";
