...
public class InfluxDBClient {
     ...
     */
    public void persistContainer(BatchPoints container) {
     ...
     * @return container
     */
    public BatchPoints getEmptyContainer() {
        return BatchPoints.database(credentials.getInfluxDBTSDB()).build();
    }

    /**
     * Persist single point
     * @param point to be stored
     */
    public void persistSinglePoint(Point point) {
    ...
    public List<Map> executeQuery(QueryBuilder builder) {
        ...
        return ParseQueryResult.process(result);
    }
}