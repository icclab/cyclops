...
public class PublisherCredentials {
    ...
    public static String DEFAULT_PUBLISHER_DISPATCH_EXCHANGE = "cyclops.ceilometer.collector.dispatch";
    public static String DEFAULT_PUBLISHER_BROADCAST_EXCHANGE = "cyclops.ceilometer.collector.broadcast";
    ...
    private Boolean publisherIncludeAlsoUnknown;
    ...
    public Boolean getPublisherByDefaultDispatchInsteadOfBroadcast() {
    ...
    public Boolean getPublisherIncludeAlsoUnknown() {
        return publisherIncludeAlsoUnknown;
    }
    public void setPublisherIncludeAlsoUnknown(Boolean publisherIncludeAlsoUnknown) {
        this.publisherIncludeAlsoUnknown = publisherIncludeAlsoUnknown;
    }
}
