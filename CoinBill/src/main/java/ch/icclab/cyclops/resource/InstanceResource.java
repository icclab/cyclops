...
public class InstanceResource {
     ...
     */
    public void removeInstances(String name) throws RuleException, DatabaseException {
        logger.trace("Removing instance with name: " + name);

        // execute query and get number of rows affected
        List<InstanceORM> instances = listInstances();
        for (InstanceORM instance :
                instances) {
            System.out.println("Instance name: " + instance.getName());
            if (instance.getName().equals(name)) {
                // TODO: 04.09.18 add logs
